        ...
        <section>
            ...
            if ($lang == 'tr') { ?>
                <div class="ds-button-sec text-center">
                    <a target="_blank" href="<?php echo base_url_back(). $about['cv'] ?>" class="ds-button">Özgeçmişi İndir</a>
                </div>
            <?php } else { ?>
                <div class="ds-button-sec text-center">
                    <a target="_blank" href="<?php echo base_url_back(). $about['cvE'] ?>" class="ds-button">Download  CV</a>
                </div>
            <?php } ?>
        </section>
    </div>
