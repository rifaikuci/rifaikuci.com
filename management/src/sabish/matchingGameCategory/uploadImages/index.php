...
<head>
    ...
    <link rel="shortcut icon" type="image/png"
          href="<?php echo base_url_back() . "style/dist/img/favIcon/icon.png"; ?>">

    <title><?php echo function_exists('firmName') ? firmName() . " | " : "" ?> Eşleştirme Resimleri Yükleme</title>
    <?php
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <?php getBreadcrumb("Eşleştirme Kategorileri", 'Resim Yükle '); ?>
